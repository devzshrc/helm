                    ...
                    <AnimatePresence mode="wait">
                      {isExpanded && task.subtasks.length > 0 && (
                        ...
                        >
                          ...
                          <div className="border-muted-foreground/30 absolute top-0 bottom-0 left-[20px] border-l-2 border-dashed" />
                              ...
                              return (
                                ...
                                >
                                  ...
                                  <AnimatePresence mode="wait">
                                    {isSubtaskExpanded && (
                                      <motion.div
                                        className="text-muted-foreground border-foreground/20 mt-1 ml-1.5 overflow-hidden border-l border-dashed pl-5 text-xs"
