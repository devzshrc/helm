...
// Hooks are intentionally called per-letter in render; letter count is stable
// per label so the hook order never changes. (Vendored interactive-text component.)
